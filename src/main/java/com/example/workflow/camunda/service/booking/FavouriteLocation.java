...
@Service
public class FavouriteLocation implements JavaDelegate {

    private final Logger log = Logger.getLogger(FavouriteLocation.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
        try {
            log.info("FavouriteLocation: execute method is called......");
            ...
            if(usersStarredPlaces.isEmpty()){
                messageService.sendTextMessage(new SendMessageRequestDto(execution.getBusinessKey(), templateService.format(MessageTemplate.FAVOURITE_PLACES_NOT_FOUND, user.getPreferredLanguage())));
            } else {
            ...
            log.warning("FavouriteLocation: Exception occurred......");
